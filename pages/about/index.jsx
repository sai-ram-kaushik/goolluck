        ...
        <div className='flex items-center justify-center gap-32 mt-10'>
          <div className='flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-52 mt-10'>
            <div className='flex flex-col items-center text-center gap-10'>
              ...
              <p className='text-justify  text-lg max-w-[900px]'>
                ...
                innovation, and a passion for education, we have become a
                trusted resource for financial education and training.
              </p>
            </div>
          </div>
        </div>
